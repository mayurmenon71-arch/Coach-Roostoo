...
once a minute and there's no seconds-level scalping: the more often an agent
...
bleeds less on fees (good for trend/momentum styles); a 1- or 5-minute
frequency reacts faster but must be more selective (mean-reversion, flow). Either way,
